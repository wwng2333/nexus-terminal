...
export const Theme_3024NightPreset: TerminalTheme = {
  _id: 'preset-3024-night',
  name: '3024 Night', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#a5a2a2',
    background: '#090300',
...
export const AardvarkBluePreset: TerminalTheme = {
  _id: 'preset-aardvark-blue',
  name: 'Aardvark Blue', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dddddd',
    background: '#102040',
...
export const AbernathyPreset: TerminalTheme = {
  _id: 'preset-abernathy',
  name: 'Abernathy', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#eeeeec',
    background: '#111416',
...
export const AdventurePreset: TerminalTheme = {
  _id: 'preset-adventure',
  name: 'Adventure', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#feffff',
    background: '#040404',
...
export const AdventureTimePreset: TerminalTheme = {
  _id: 'preset-adventuretime',
  name: 'AdventureTime', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f8dcc0',
    background: '#1f1d45',
...
export const AdwaitaDarkPreset: TerminalTheme = {
  _id: 'preset-adwaita-dark',
  name: 'Adwaita Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#1e1e1e',
...
export const AfterglowPreset: TerminalTheme = {
  _id: 'preset-afterglow',
  name: 'Afterglow', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d0d0d0',
    background: '#212121',
...
export const AlabasterPreset: TerminalTheme = {
  _id: 'preset-alabaster',
  name: 'Alabaster', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#f7f7f7',
...
export const AlienBloodPreset: TerminalTheme = {
  _id: 'preset-alienblood',
  name: 'AlienBlood', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#637d75',
    background: '#0f1610',
...
export const AndromedaPreset: TerminalTheme = {
  _id: 'preset-andromeda',
  name: 'Andromeda', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e5e5e5',
    background: '#262a33',
...
export const AppleClassicPreset: TerminalTheme = {
  _id: 'preset-apple-classic',
  name: 'Apple Classic', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d5a200',
    background: '#2c2b2b',
...
export const AppleSystemColorsPreset: TerminalTheme = {
  _id: 'preset-apple-system-colors',
  name: 'Apple System Colors', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#1e1e1e',
...
export const AppleSystemColorsLightPreset: TerminalTheme = {
  _id: 'preset-apple-system-colors-light',
  name: 'Apple System Colors Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#feffff',
...
export const AtelierSulphurpoolPreset: TerminalTheme = {
  _id: 'preset-ateliersulphurpool',
  name: 'AtelierSulphurpool', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#979db4',
    background: '#202746',
...
export const AtomOneDarkPreset: TerminalTheme = {
  _id: 'preset-atomonedark',
  name: 'AtomOneDark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#abb2bf',
    background: '#21252b',
...
export const AtomOneLightPreset: TerminalTheme = {
  _id: 'preset-atomonelight',
  name: 'AtomOneLight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#2a2c33',
    background: '#f9f9f9',
...
export const AyuMiragePreset: TerminalTheme = {
  _id: 'preset-ayu-mirage',
  name: 'Ayu Mirage', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cbccc6',
    background: '#1f2430',
...
export const ayuLightPreset: TerminalTheme = {
  _id: 'preset-ayu-light',
  name: 'ayu_light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#5c6773',
    background: '#fafafa',
...
export const BananaBlueberryPreset: TerminalTheme = {
  _id: 'preset-banana-blueberry',
  name: 'Banana Blueberry', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cccccc',
    background: '#191323',
...
export const BelafonteDayPreset: TerminalTheme = {
  _id: 'preset-belafonte-day',
  name: 'Belafonte Day', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#45373c',
    background: '#d5ccba',
...
export const BelafonteNightPreset: TerminalTheme = {
  _id: 'preset-belafonte-night',
  name: 'Belafonte Night', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#968c83',
    background: '#20111b',
...
export const BirdsOfParadisePreset: TerminalTheme = {
  _id: 'preset-birdsofparadise',
  name: 'BirdsOfParadise', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e0dbb7',
    background: '#2a1f1d',
...
export const BlueMatrixPreset: TerminalTheme = {
  _id: 'preset-blue-matrix',
  name: 'Blue Matrix', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#00a2ff',
    background: '#101116',
...
export const BlueBerryPiePreset: TerminalTheme = {
  _id: 'preset-blueberrypie',
  name: 'BlueBerryPie', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#babab9',
    background: '#1c0c28',
...
export const BlueDolphinPreset: TerminalTheme = {
  _id: 'preset-bluedolphin',
  name: 'BlueDolphin', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c5f2ff',
    background: '#006984',
...
export const BlulocoDarkPreset: TerminalTheme = {
  _id: 'preset-blulocodark',
  name: 'BlulocoDark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b9c0cb',
    background: '#282c34',
...
export const BlulocoLightPreset: TerminalTheme = {
  _id: 'preset-blulocolight',
  name: 'BlulocoLight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#373a41',
    background: '#f9f9f9',
...
export const BrightLightsPreset: TerminalTheme = {
  _id: 'preset-bright-lights',
  name: 'Bright Lights', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b3c9d7',
    background: '#191919',
...
export const BroadcastPreset: TerminalTheme = {
  _id: 'preset-broadcast',
  name: 'Broadcast', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e6e1dc',
    background: '#2b2b2b',
...
export const BrogrammerPreset: TerminalTheme = {
  _id: 'preset-brogrammer',
  name: 'Brogrammer', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d6dbe5',
    background: '#131313',
...
export const BuiltinDarkPreset: TerminalTheme = {
  _id: 'preset-builtin-dark',
  name: 'Builtin Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#bbbbbb',
    background: '#000000',
...
export const BuiltinLightPreset: TerminalTheme = {
  _id: 'preset-builtin-light',
  name: 'Builtin Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#ffffff',
...
export const BuiltinPastelDarkPreset: TerminalTheme = {
  _id: 'preset-builtin-pastel-dark',
  name: 'Builtin Pastel Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#bbbbbb',
    background: '#000000',
...
export const BuiltinSolarizedDarkPreset: TerminalTheme = {
  _id: 'preset-builtin-solarized-dark',
  name: 'Builtin Solarized Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#839496',
    background: '#002b36',
...
export const BuiltinSolarizedLightPreset: TerminalTheme = {
  _id: 'preset-builtin-solarized-light',
  name: 'Builtin Solarized Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#657b83',
    background: '#fdf6e3',
...
export const BuiltinTangoDarkPreset: TerminalTheme = {
  _id: 'preset-builtin-tango-dark',
  name: 'Builtin Tango Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#000000',
...
export const BuiltinTangoLightPreset: TerminalTheme = {
  _id: 'preset-builtin-tango-light',
  name: 'Builtin Tango Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#ffffff',
...
export const catppuccinFrappePreset: TerminalTheme = {
  _id: 'preset-catppuccin-frappe',
  name: 'catppuccin-frappe', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c6d0f5',
    background: '#303446',
...
export const catppuccinLattePreset: TerminalTheme = {
  _id: 'preset-catppuccin-latte',
  name: 'catppuccin-latte', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#4c4f69',
    background: '#eff1f5',
...
export const catppuccinMacchiatoPreset: TerminalTheme = {
  _id: 'preset-catppuccin-macchiato',
  name: 'catppuccin-macchiato', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cad3f5',
    background: '#24273a',
...
export const catppuccinMochaPreset: TerminalTheme = {
  _id: 'preset-catppuccin-mocha',
  name: 'catppuccin-mocha', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cdd6f4',
    background: '#1e1e2e',
...
export const ChalkboardPreset: TerminalTheme = {
  _id: 'preset-chalkboard',
  name: 'Chalkboard', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d9e6f2',
    background: '#29262f',
...
export const ChallengerDeepPreset: TerminalTheme = {
  _id: 'preset-challengerdeep',
  name: 'ChallengerDeep', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cbe1e7',
    background: '#1e1c31',
...
export const citruszestPreset: TerminalTheme = {
  _id: 'preset-citruszest',
  name: 'citruszest', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#bfbfbf',
    background: '#121212',
...
export const CobaltNeonPreset: TerminalTheme = {
  _id: 'preset-cobalt-neon',
  name: 'Cobalt Neon', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#8ff586',
    background: '#142838',
...
export const CobaltNextPreset: TerminalTheme = {
  _id: 'preset-cobaltnext',
  name: 'CobaltNext', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d8dee9',
    background: '#1b2b34',
...
export const CobaltNextDarkPreset: TerminalTheme = {
  _id: 'preset-cobaltnext-dark',
  name: 'CobaltNext-Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d8dee9',
    background: '#0f1c23',
...
export const CobaltNextMinimalPreset: TerminalTheme = {
  _id: 'preset-cobaltnext-minimal',
  name: 'CobaltNext-Minimal', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d8dee9',
    background: '#0f1c23',
...
export const coffeeThemePreset: TerminalTheme = {
  _id: 'preset-coffee-theme',
  name: 'coffee_theme', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#f5deb3',
...
export const CrayonPonyFishPreset: TerminalTheme = {
  _id: 'preset-crayonponyfish',
  name: 'CrayonPonyFish', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#68525a',
    background: '#150707',
...
export const CyberdynePreset: TerminalTheme = {
  _id: 'preset-cyberdyne',
  name: 'Cyberdyne', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#00ff92',
    background: '#151144',
...
export const cyberpunkPreset: TerminalTheme = {
  _id: 'preset-cyberpunk',
  name: 'cyberpunk', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e5e5e5',
    background: '#332a57',
...
export const CyberpunkScarletProtocolPreset: TerminalTheme = {
  _id: 'preset-cyberpunkscarletprotocol',
  name: 'CyberpunkScarletProtocol', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d13554',
    background: '#101116',
...
export const DarkModernPreset: TerminalTheme = {
  _id: 'preset-dark-modern',
  name: 'Dark Modern', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cccccc',
    background: '#1f1f1f',
...
export const DarkPastelPreset: TerminalTheme = {
  _id: 'preset-dark-pastel',
  name: 'Dark Pastel', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#000000',
...
export const darkermatrixPreset: TerminalTheme = {
  _id: 'preset-darkermatrix',
  name: 'darkermatrix', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#28380d',
    background: '#070c0e',
...
export const darkmatrixPreset: TerminalTheme = {
  _id: 'preset-darkmatrix',
  name: 'darkmatrix', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#3e5715',
    background: '#070c0e',
...
export const DimmedMonokaiPreset: TerminalTheme = {
  _id: 'preset-dimmedmonokai',
  name: 'DimmedMonokai', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b9bcba',
    background: '#1f1f1f',
...
export const DjangoRebornAgainPreset: TerminalTheme = {
  _id: 'preset-djangorebornagain',
  name: 'DjangoRebornAgain', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dadedc',
    background: '#051f14',
...
export const DjangoSmoothPreset: TerminalTheme = {
  _id: 'preset-djangosmooth',
  name: 'DjangoSmooth', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f8f8f8',
    background: '#245032',
...
export const DoomPeacockPreset: TerminalTheme = {
  _id: 'preset-doom-peacock',
  name: 'Doom Peacock', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ede0ce',
    background: '#2b2a27',
...
export const duckbonesPreset: TerminalTheme = {
  _id: 'preset-duckbones',
  name: 'duckbones', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ebefc0',
    background: '#0e101a',
...
export const DuotoneDarkPreset: TerminalTheme = {
  _id: 'preset-duotone-dark',
  name: 'Duotone Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b7a1ff',
    background: '#1f1d27',
...
export const EarthsongPreset: TerminalTheme = {
  _id: 'preset-earthsong',
  name: 'Earthsong', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e5c7a9',
    background: '#292520',
...
export const electronHighlighterPreset: TerminalTheme = {
  _id: 'preset-electron-highlighter',
  name: 'electron-highlighter', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#a8b5d1',
    background: '#24283b',
...
export const ElementalPreset: TerminalTheme = {
  _id: 'preset-elemental',
  name: 'Elemental', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#807a74',
    background: '#22211d',
...
export const ElementaryPreset: TerminalTheme = {
  _id: 'preset-elementary',
  name: 'Elementary', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#efefef',
    background: '#181818',
...
export const embersDarkPreset: TerminalTheme = {
  _id: 'preset-embers-dark',
  name: 'embers-dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#a39a90',
    background: '#16130f',
...
export const EspressoLibrePreset: TerminalTheme = {
  _id: 'preset-espresso-libre',
  name: 'Espresso Libre', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b8a898',
    background: '#2a211c',
...
export const EverblushPreset: TerminalTheme = {
  _id: 'preset-everblush',
  name: 'Everblush', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dadada',
    background: '#141b1e',
...
export const EverforestDarkHardPreset: TerminalTheme = {
  _id: 'preset-everforest-dark-hard',
  name: 'Everforest Dark - Hard', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d3c6aa',
    background: '#1e2326',
...
export const FahrenheitPreset: TerminalTheme = {
  _id: 'preset-fahrenheit',
  name: 'Fahrenheit', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffce',
    background: '#000000',
...
export const FairyflossPreset: TerminalTheme = {
  _id: 'preset-fairyfloss',
  name: 'Fairyfloss', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f8f8f2',
    background: '#5a5475',
...
export const farmhouseDarkPreset: TerminalTheme = {
  _id: 'preset-farmhouse-dark',
  name: 'farmhouse-dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e8e4e1',
    background: '#1d2027',
...
export const farmhouseLightPreset: TerminalTheme = {
  _id: 'preset-farmhouse-light',
  name: 'farmhouse-light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#1d2027',
    background: '#e8e4e1',
...
export const FideloperPreset: TerminalTheme = {
  _id: 'preset-fideloper',
  name: 'Fideloper', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dbdae0',
    background: '#292f33',
...
export const FireflyTraditionalPreset: TerminalTheme = {
  _id: 'preset-firefly-traditional',
  name: 'Firefly Traditional', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f5f5f5',
    background: '#000000',
...
export const FirefoxDevPreset: TerminalTheme = {
  _id: 'preset-firefoxdev',
  name: 'FirefoxDev', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#7c8fa4',
    background: '#0e1011',
...
export const FirewatchPreset: TerminalTheme = {
  _id: 'preset-firewatch',
  name: 'Firewatch', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#9ba2b2',
    background: '#1e2027',
...
export const flexokiDarkPreset: TerminalTheme = {
  _id: 'preset-flexoki-dark',
  name: 'flexoki-dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cecdc3',
    background: '#100f0f',
...
export const flexokiLightPreset: TerminalTheme = {
  _id: 'preset-flexoki-light',
  name: 'flexoki-light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#100f0f',
    background: '#fffcf0',
...
export const FloraversePreset: TerminalTheme = {
  _id: 'preset-floraverse',
  name: 'Floraverse', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dbd1b9',
    background: '#0e0d15',
...
export const ForestBluePreset: TerminalTheme = {
  _id: 'preset-forestblue',
  name: 'ForestBlue', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e2d8cd',
    background: '#051519',
...
export const FrontEndDelightPreset: TerminalTheme = {
  _id: 'preset-frontenddelight',
  name: 'FrontEndDelight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#adadad',
    background: '#1b1c1d',
...
export const FunForrestPreset: TerminalTheme = {
  _id: 'preset-funforrest',
  name: 'FunForrest', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dec165',
    background: '#251200',
...
export const GhosttyDefaultStyleDarkPreset: TerminalTheme = {
  _id: 'preset-ghostty-default-styledark',
  name: 'Ghostty Default StyleDark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#292c33',
...
export const GitHubDarkPreset: TerminalTheme = {
  _id: 'preset-github-dark',
  name: 'GitHub Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#8b949e',
    background: '#101216',
...
export const GitHubDarkColorblindPreset: TerminalTheme = {
  _id: 'preset-github-dark-colorblind',
  name: 'GitHub-Dark-Colorblind', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c9d1d9',
    background: '#0d1117',
...
export const GitHubDarkDefaultPreset: TerminalTheme = {
  _id: 'preset-github-dark-default',
  name: 'GitHub-Dark-Default', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e6edf3',
    background: '#0d1117',
...
export const GitHubDarkDimmedPreset: TerminalTheme = {
  _id: 'preset-github-dark-dimmed',
  name: 'GitHub-Dark-Dimmed', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#adbac7',
    background: '#22272e',
...
export const GitHubDarkHighContrastPreset: TerminalTheme = {
  _id: 'preset-github-dark-high-contrast',
  name: 'GitHub-Dark-High-Contrast', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f0f3f6',
    background: '#0a0c10',
...
export const GitHubLightColorblindPreset: TerminalTheme = {
  _id: 'preset-github-light-colorblind',
  name: 'GitHub-Light-Colorblind', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#24292f',
    background: '#ffffff',
...
export const GitHubLightDefaultPreset: TerminalTheme = {
  _id: 'preset-github-light-default',
  name: 'GitHub-Light-Default', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#1f2328',
    background: '#ffffff',
...
export const GitHubLightHighContrastPreset: TerminalTheme = {
  _id: 'preset-github-light-high-contrast',
  name: 'GitHub-Light-High-Contrast', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#0e1116',
    background: '#ffffff',
...
export const GitLabDarkPreset: TerminalTheme = {
  _id: 'preset-gitlab-dark',
  name: 'GitLab-Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#28262b',
...
export const GitLabDarkGreyPreset: TerminalTheme = {
  _id: 'preset-gitlab-dark-grey',
  name: 'GitLab-Dark-Grey', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#222222',
...
export const GitLabLightPreset: TerminalTheme = {
  _id: 'preset-gitlab-light',
  name: 'GitLab-Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#303030',
    background: '#fafaff',
...
export const GreyGreenPreset: TerminalTheme = {
  _id: 'preset-grey-green',
  name: 'Grey-green', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#002a1a',
...
export const gruberDarkerPreset: TerminalTheme = {
  _id: 'preset-gruber-darker',
  name: 'gruber-darker', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e4e4e4',
    background: '#181818',
...
export const gruvboxMaterialPreset: TerminalTheme = {
  _id: 'preset-gruvbox-material',
  name: 'gruvbox-material', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d4be98',
    background: '#1d2021',
...
export const GruvboxDarkPreset: TerminalTheme = {
  _id: 'preset-gruvboxdark',
  name: 'GruvboxDark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ebdbb2',
    background: '#282828',
...
export const GruvboxDarkHardPreset: TerminalTheme = {
  _id: 'preset-gruvboxdarkhard',
  name: 'GruvboxDarkHard', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ebdbb2',
    background: '#1d2021',
...
export const GruvboxLightPreset: TerminalTheme = {
  _id: 'preset-gruvboxlight',
  name: 'GruvboxLight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#282828',
    background: '#fbf1c7',
...
export const GruvboxLightHardPreset: TerminalTheme = {
  _id: 'preset-gruvboxlighthard',
  name: 'GruvboxLightHard', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#282828',
    background: '#f8f4d6',
...
export const HacktoberPreset: TerminalTheme = {
  _id: 'preset-hacktober',
  name: 'Hacktober', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c9c9c9',
    background: '#141414',
...
export const HavnDaggryPreset: TerminalTheme = {
  _id: 'preset-havn-daggry',
  name: 'Havn Daggry', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#3e4a77',
    background: '#f8f9fb',
...
export const HavnSkumringPreset: TerminalTheme = {
  _id: 'preset-havn-skumring',
  name: 'Havn Skumring', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d7dbea',
    background: '#121521',
...
export const HaX0RBLUEPreset: TerminalTheme = {
  _id: 'preset-hax0r-blue',
  name: 'HaX0R_BLUE', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#11b7ff',
    background: '#010515',
...
export const HaX0RGR33NPreset: TerminalTheme = {
  _id: 'preset-hax0r-gr33n',
  name: 'HaX0R_GR33N', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#16b10e',
    background: '#020f01',
...
export const HaX0RR3DPreset: TerminalTheme = {
  _id: 'preset-hax0r-r3d',
  name: 'HaX0R_R3D', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b10e0e',
    background: '#200101',
...
export const HipsterGreenPreset: TerminalTheme = {
  _id: 'preset-hipster-green',
  name: 'Hipster Green', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#84c138',
    background: '#100b05',
...
export const HopscotchPreset: TerminalTheme = {
  _id: 'preset-hopscotch',
  name: 'Hopscotch', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b9b5b8',
    background: '#322931',
...
export const Hopscotch_256Preset: TerminalTheme = {
  _id: 'preset-hopscotch-256',
  name: 'Hopscotch.256', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b9b5b8',
    background: '#322931',
...
export const HorizonBrightPreset: TerminalTheme = {
  _id: 'preset-horizon-bright',
  name: 'Horizon-Bright', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#16161c',
    background: '#fbf0ee',
...
export const ICGreenPPLPreset: TerminalTheme = {
  _id: 'preset-ic-green-ppl',
  name: 'IC_Green_PPL', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e0f1dc',
    background: '#2c2c2c',
...
export const ICOrangePPLPreset: TerminalTheme = {
  _id: 'preset-ic-orange-ppl',
  name: 'IC_Orange_PPL', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffcb83',
    background: '#262626',
...
export const icebergDarkPreset: TerminalTheme = {
  _id: 'preset-iceberg-dark',
  name: 'iceberg-dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c6c8d1',
    background: '#161821',
...
export const icebergLightPreset: TerminalTheme = {
  _id: 'preset-iceberg-light',
  name: 'iceberg-light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#33374c',
    background: '#e8e9ec',
...
export const IRIXConsolePreset: TerminalTheme = {
  _id: 'preset-irix-console',
  name: 'IRIX Console', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f2f2f2',
    background: '#0c0c0c',
...
export const IRIXTerminalPreset: TerminalTheme = {
  _id: 'preset-irix-terminal',
  name: 'IRIX Terminal', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f2f2f2',
    background: '#000043',
...
export const iTerm2DarkBackgroundPreset: TerminalTheme = {
  _id: 'preset-iterm2-dark-background',
  name: 'iTerm2 Dark Background', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c7c7c7',
    background: '#000000',
...
export const iTerm2DefaultPreset: TerminalTheme = {
  _id: 'preset-iterm2-default',
  name: 'iTerm2 Default', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#000000',
...
export const iTerm2LightBackgroundPreset: TerminalTheme = {
  _id: 'preset-iterm2-light-background',
  name: 'iTerm2 Light Background', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#ffffff',
...
export const iTerm2PastelDarkBackgroundPreset: TerminalTheme = {
  _id: 'preset-iterm2-pastel-dark-background',
  name: 'iTerm2 Pastel Dark Background', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c7c7c7',
    background: '#000000',
...
export const iTerm2SmooooothPreset: TerminalTheme = {
  _id: 'preset-iterm2-smoooooth',
  name: 'iTerm2 Smoooooth', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dcdcdc',
    background: '#15191f',
...
export const iTerm2SolarizedDarkPreset: TerminalTheme = {
  _id: 'preset-iterm2-solarized-dark',
  name: 'iTerm2 Solarized Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#839496',
    background: '#002b36',
...
export const iTerm2SolarizedLightPreset: TerminalTheme = {
  _id: 'preset-iterm2-solarized-light',
  name: 'iTerm2 Solarized Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#657b83',
    background: '#fdf6e3',
...
export const iTerm2TangoDarkPreset: TerminalTheme = {
  _id: 'preset-iterm2-tango-dark',
  name: 'iTerm2 Tango Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#000000',
...
export const iTerm2TangoLightPreset: TerminalTheme = {
  _id: 'preset-iterm2-tango-light',
  name: 'iTerm2 Tango Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#ffffff',
...
export const JackieBrownPreset: TerminalTheme = {
  _id: 'preset-jackie-brown',
  name: 'Jackie Brown', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffcc2f',
    background: '#2c1d16',
...
export const JapanesquePreset: TerminalTheme = {
  _id: 'preset-japanesque',
  name: 'Japanesque', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f7f6ec',
    background: '#1e1e1e',
...
export const JellybeansPreset: TerminalTheme = {
  _id: 'preset-jellybeans',
  name: 'Jellybeans', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dedede',
    background: '#121212',
...
export const JetBrainsDarculaPreset: TerminalTheme = {
  _id: 'preset-jetbrains-darcula',
  name: 'JetBrains Darcula', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#adadad',
    background: '#202020',
...
export const KanagawaDragonPreset: TerminalTheme = {
  _id: 'preset-kanagawa-dragon',
  name: 'Kanagawa Dragon', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c8c093',
    background: '#181616',
...
export const KanagawaWavePreset: TerminalTheme = {
  _id: 'preset-kanagawa-wave',
  name: 'Kanagawa Wave', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dcd7ba',
    background: '#1f1f28',
...
export const kanagawabonesPreset: TerminalTheme = {
  _id: 'preset-kanagawabones',
  name: 'kanagawabones', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ddd8bb',
    background: '#1f1f28',
...
export const LaterThisEveningPreset: TerminalTheme = {
  _id: 'preset-later-this-evening',
  name: 'Later This Evening', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#959595',
    background: '#222222',
...
export const LavandulaPreset: TerminalTheme = {
  _id: 'preset-lavandula',
  name: 'Lavandula', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#736e7d',
    background: '#050014',
...
export const LiquidCarbonPreset: TerminalTheme = {
  _id: 'preset-liquidcarbon',
  name: 'LiquidCarbon', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#afc2c2',
    background: '#303030',
...
export const LiquidCarbonTransparentPreset: TerminalTheme = {
  _id: 'preset-liquidcarbontransparent',
  name: 'LiquidCarbonTransparent', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#afc2c2',
    background: '#000000',
...
export const LiquidCarbonTransparentInversePreset: TerminalTheme = {
  _id: 'preset-liquidcarbontransparentinverse',
  name: 'LiquidCarbonTransparentInverse', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#afc2c2',
    background: '#000000',
...
export const MaterialDarkPreset: TerminalTheme = {
  _id: 'preset-materialdark',
  name: 'MaterialDark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e5e5e5',
    background: '#232322',
...
export const MaterialDarkerPreset: TerminalTheme = {
  _id: 'preset-materialdarker',
  name: 'MaterialDarker', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#eeffff',
    background: '#212121',
...
export const MaterialDesignColorsPreset: TerminalTheme = {
  _id: 'preset-materialdesigncolors',
  name: 'MaterialDesignColors', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e7ebed',
    background: '#1d262a',
...
export const MaterialOceanPreset: TerminalTheme = {
  _id: 'preset-materialocean',
  name: 'MaterialOcean', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#8f93a2',
    background: '#0f111a',
...
export const MedallionPreset: TerminalTheme = {
  _id: 'preset-medallion',
  name: 'Medallion', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cac296',
    background: '#1d1908',
...
export const MelangeDarkPreset: TerminalTheme = {
  _id: 'preset-melange-dark',
  name: 'Melange_dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ece1d7',
    background: '#292522',
...
export const MelangeLightPreset: TerminalTheme = {
  _id: 'preset-melange-light',
  name: 'Melange_light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#54433a',
    background: '#f1f1f1',
...
export const MellifluousPreset: TerminalTheme = {
  _id: 'preset-mellifluous',
  name: 'Mellifluous', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dadada',
    background: '#1a1a1a',
...
export const midnightInMojavePreset: TerminalTheme = {
  _id: 'preset-midnight-in-mojave',
  name: 'midnight-in-mojave', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#1e1e1e',
...
export const MisteriosoPreset: TerminalTheme = {
  _id: 'preset-misterioso',
  name: 'Misterioso', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e1e1e0',
    background: '#2d3743',
...
export const MonokaiClassicPreset: TerminalTheme = {
  _id: 'preset-monokai-classic',
  name: 'Monokai Classic', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#fdfff1',
    background: '#272822',
...
export const MonokaiProPreset: TerminalTheme = {
  _id: 'preset-monokai-pro',
  name: 'Monokai Pro', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#fcfcfa',
    background: '#2d2a2e',
...
export const MonokaiProLightPreset: TerminalTheme = {
  _id: 'preset-monokai-pro-light',
  name: 'Monokai Pro Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#29242a',
    background: '#faf4f2',
...
export const MonokaiProLightSunPreset: TerminalTheme = {
  _id: 'preset-monokai-pro-light-sun',
  name: 'Monokai Pro Light Sun', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#2c232e',
    background: '#f8efe7',
...
export const MonokaiProMachinePreset: TerminalTheme = {
  _id: 'preset-monokai-pro-machine',
  name: 'Monokai Pro Machine', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f2fffc',
    background: '#273136',
...
export const MonokaiProOctagonPreset: TerminalTheme = {
  _id: 'preset-monokai-pro-octagon',
  name: 'Monokai Pro Octagon', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#eaf2f1',
    background: '#282a3a',
...
export const MonokaiProRistrettoPreset: TerminalTheme = {
  _id: 'preset-monokai-pro-ristretto',
  name: 'Monokai Pro Ristretto', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#fff1f3',
    background: '#2c2525',
...
export const MonokaiProSpectrumPreset: TerminalTheme = {
  _id: 'preset-monokai-pro-spectrum',
  name: 'Monokai Pro Spectrum', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f7f1ff',
    background: '#222222',
...
export const MonokaiRemasteredPreset: TerminalTheme = {
  _id: 'preset-monokai-remastered',
  name: 'Monokai Remastered', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d9d9d9',
    background: '#0c0c0c',
...
export const MonokaiSodaPreset: TerminalTheme = {
  _id: 'preset-monokai-soda',
  name: 'Monokai Soda', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c4c5b5',
    background: '#1a1a1a',
...
export const MonokaiVividPreset: TerminalTheme = {
  _id: 'preset-monokai-vivid',
  name: 'Monokai Vivid', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f9f9f9',
    background: '#121212',
...
export const neobonesDarkPreset: TerminalTheme = {
  _id: 'preset-neobones-dark',
  name: 'neobones_dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c6d5cf',
    background: '#0f191f',
...
export const neobonesLightPreset: TerminalTheme = {
  _id: 'preset-neobones-light',
  name: 'neobones_light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#202e18',
    background: '#e5ede6',
...
export const NeopolitanPreset: TerminalTheme = {
  _id: 'preset-neopolitan',
  name: 'Neopolitan', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#271f19',
...
export const NightOwlishLightPreset: TerminalTheme = {
  _id: 'preset-night-owlish-light',
  name: 'Night Owlish Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#403f53',
    background: '#ffffff',
...
export const NightLionV1Preset: TerminalTheme = {
  _id: 'preset-nightlion-v1',
  name: 'NightLion v1', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#bbbbbb',
    background: '#000000',
...
export const NightLionV2Preset: TerminalTheme = {
  _id: 'preset-nightlion-v2',
  name: 'NightLion v2', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#bbbbbb',
    background: '#171717',
...
export const NocturnalWinterPreset: TerminalTheme = {
  _id: 'preset-nocturnal-winter',
  name: 'Nocturnal Winter', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e6e5e5',
    background: '#0d0d17',
...
export const nordLightPreset: TerminalTheme = {
  _id: 'preset-nord-light',
  name: 'nord-light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#414858',
    background: '#e5e9f0',
...
export const nordWavePreset: TerminalTheme = {
  _id: 'preset-nord-wave',
  name: 'nord-wave', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d8dee9',
    background: '#212121',
...
export const NvimLightPreset: TerminalTheme = {
  _id: 'preset-nvimlight',
  name: 'NvimLight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#14161b',
    background: '#e0e2ea',
...
export const OceanicNextPreset: TerminalTheme = {
  _id: 'preset-oceanic-next',
  name: 'Oceanic-Next', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c1c5cd',
    background: '#1b2b34',
...
export const OceanicMaterialPreset: TerminalTheme = {
  _id: 'preset-oceanicmaterial',
  name: 'OceanicMaterial', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c2c8d7',
    background: '#1c262b',
...
export const OneDoubleDarkPreset: TerminalTheme = {
  _id: 'preset-one-double-dark',
  name: 'One Double Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dcdfe4',
    background: '#292c33',
...
export const OneDoubleLightPreset: TerminalTheme = {
  _id: 'preset-one-double-light',
  name: 'One Double Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#383a42',
    background: '#fafafa',
...
export const OneHalfDarkPreset: TerminalTheme = {
  _id: 'preset-onehalfdark',
  name: 'OneHalfDark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dcdfe4',
    background: '#282c34',
...
export const OneHalfLightPreset: TerminalTheme = {
  _id: 'preset-onehalflight',
  name: 'OneHalfLight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#383a42',
    background: '#fafafa',
...
export const OperatorMonoDarkPreset: TerminalTheme = {
  _id: 'preset-operator-mono-dark',
  name: 'Operator Mono Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c3cac2',
    background: '#191919',
...
export const OvernightSlumberPreset: TerminalTheme = {
  _id: 'preset-overnight-slumber',
  name: 'Overnight Slumber', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ced2d6',
    background: '#0e1729',
...
export const OxocarbonPreset: TerminalTheme = {
  _id: 'preset-oxocarbon',
  name: 'Oxocarbon', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f2f4f8',
    background: '#161616',
...
export const PaleNightHCPreset: TerminalTheme = {
  _id: 'preset-palenighthc',
  name: 'PaleNightHC', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cccccc',
    background: '#3e4251',
...
export const ParaisoDarkPreset: TerminalTheme = {
  _id: 'preset-paraiso-dark',
  name: 'Paraiso Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#a39e9b',
    background: '#2f1e2e',
...
export const PaulMillrPreset: TerminalTheme = {
  _id: 'preset-paulmillr',
  name: 'PaulMillr', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f2f2f2',
    background: '#000000',
...
export const PencilDarkPreset: TerminalTheme = {
  _id: 'preset-pencildark',
  name: 'PencilDark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f1f1f1',
    background: '#212121',
...
export const PencilLightPreset: TerminalTheme = {
  _id: 'preset-pencillight',
  name: 'PencilLight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#424242',
    background: '#f1f1f1',
...
export const PeppermintPreset: TerminalTheme = {
  _id: 'preset-peppermint',
  name: 'Peppermint', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c8c8c8',
    background: '#000000',
...
export const PiattoLightPreset: TerminalTheme = {
  _id: 'preset-piatto-light',
  name: 'Piatto Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#414141',
    background: '#ffffff',
...
export const PoppingAndLockingPreset: TerminalTheme = {
  _id: 'preset-popping-and-locking',
  name: 'Popping and Locking', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ebdbb2',
    background: '#181921',
...
export const ProLightPreset: TerminalTheme = {
  _id: 'preset-pro-light',
  name: 'Pro Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#191919',
    background: '#ffffff',
...
export const PurpleRainPreset: TerminalTheme = {
  _id: 'preset-purple-rain',
  name: 'Purple Rain', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#fffbf6',
    background: '#21084a',
...
export const purplepeterPreset: TerminalTheme = {
  _id: 'preset-purplepeter',
  name: 'purplepeter', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ece7fa',
    background: '#2a1a4a',
...
export const RaycastDarkPreset: TerminalTheme = {
  _id: 'preset-raycast-dark',
  name: 'Raycast_Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#1a1a1a',
...
export const RaycastLightPreset: TerminalTheme = {
  _id: 'preset-raycast-light',
  name: 'Raycast_Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#ffffff',
...
export const RedAlertPreset: TerminalTheme = {
  _id: 'preset-red-alert',
  name: 'Red Alert', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#762423',
...
export const RedPlanetPreset: TerminalTheme = {
  _id: 'preset-red-planet',
  name: 'Red Planet', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c2b790',
    background: '#222222',
...
export const RedSandsPreset: TerminalTheme = {
  _id: 'preset-red-sands',
  name: 'Red Sands', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d7c9a7',
    background: '#7a251e',
...
export const RetroLegendsPreset: TerminalTheme = {
  _id: 'preset-retrolegends',
  name: 'RetroLegends', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#45eb45',
    background: '#0d0d0d',
...
export const RippedcastsPreset: TerminalTheme = {
  _id: 'preset-rippedcasts',
  name: 'Rippedcasts', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#2b2b2b',
...
export const rosePinePreset: TerminalTheme = {
  _id: 'preset-rose-pine',
  name: 'rose-pine', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e0def4',
    background: '#191724',
...
export const rosePineDawnPreset: TerminalTheme = {
  _id: 'preset-rose-pine-dawn',
  name: 'rose-pine-dawn', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#575279',
    background: '#faf4ed',
...
export const rosePineMoonPreset: TerminalTheme = {
  _id: 'preset-rose-pine-moon',
  name: 'rose-pine-moon', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e0def4',
    background: '#232136',
...
export const ScarletProtocolPreset: TerminalTheme = {
  _id: 'preset-scarlet-protocol',
  name: 'Scarlet Protocol', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e41951',
    background: '#1c153d',
...
export const SeafoamPastelPreset: TerminalTheme = {
  _id: 'preset-seafoam-pastel',
  name: 'Seafoam Pastel', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d4e7d4',
    background: '#243435',
...
export const SeaShellsPreset: TerminalTheme = {
  _id: 'preset-seashells',
  name: 'SeaShells', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#deb88d',
    background: '#09141b',
...
export const seoulbonesDarkPreset: TerminalTheme = {
  _id: 'preset-seoulbones-dark',
  name: 'seoulbones_dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dddddd',
    background: '#4b4b4b',
...
export const seoulbonesLightPreset: TerminalTheme = {
  _id: 'preset-seoulbones-light',
  name: 'seoulbones_light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#555555',
    background: '#e2e2e2',
...
export const shadesOfPurplePreset: TerminalTheme = {
  _id: 'preset-shades-of-purple',
  name: 'shades-of-purple', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#1e1d40',
...
export const SleepyHollowPreset: TerminalTheme = {
  _id: 'preset-sleepyhollow',
  name: 'SleepyHollow', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#af9a91',
    background: '#121214',
...
export const SnazzySoftPreset: TerminalTheme = {
  _id: 'preset-snazzy-soft',
  name: 'Snazzy Soft', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#eff0eb',
    background: '#282a36',
...
export const SoftServerPreset: TerminalTheme = {
  _id: 'preset-softserver',
  name: 'SoftServer', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#99a3a2',
    background: '#242626',
...
export const SolarizedDarculaPreset: TerminalTheme = {
  _id: 'preset-solarized-darcula',
  name: 'Solarized Darcula', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d2d8d9',
    background: '#3d3f41',
...
export const SolarizedDarkPatchedPreset: TerminalTheme = {
  _id: 'preset-solarized-dark-patched',
  name: 'Solarized Dark - Patched', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#708284',
    background: '#001e27',
...
export const SolarizedDarkHigherContrastPreset: TerminalTheme = {
  _id: 'preset-solarized-dark-higher-contrast',
  name: 'Solarized Dark Higher Contrast', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#9cc2c3',
    background: '#001e27',
...
export const solarizedOsakaNightPreset: TerminalTheme = {
  _id: 'preset-solarized-osaka-night',
  name: 'solarized-osaka-night', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c2caf1',
    background: '#1a1b25',
...
export const SpacedustPreset: TerminalTheme = {
  _id: 'preset-spacedust',
  name: 'Spacedust', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ecf0c1',
    background: '#0a1e24',
...
export const SpaceGrayPreset: TerminalTheme = {
  _id: 'preset-spacegray',
  name: 'SpaceGray', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b3b8c3',
    background: '#20242d',
...
export const SpaceGrayBrightPreset: TerminalTheme = {
  _id: 'preset-spacegray-bright',
  name: 'SpaceGray Bright', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f3f3f3',
    background: '#2a2e3a',
...
export const SpaceGrayEightiesPreset: TerminalTheme = {
  _id: 'preset-spacegray-eighties',
  name: 'SpaceGray Eighties', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#bdbaae',
    background: '#222222',
...
export const SpaceGrayEightiesDullPreset: TerminalTheme = {
  _id: 'preset-spacegray-eighties-dull',
  name: 'SpaceGray Eighties Dull', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c9c6bc',
    background: '#222222',
...
export const SpidermanPreset: TerminalTheme = {
  _id: 'preset-spiderman',
  name: 'Spiderman', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e3e3e3',
    background: '#1b1d1e',
...
export const SquirrelsongDarkPreset: TerminalTheme = {
  _id: 'preset-squirrelsong-dark',
  name: 'Squirrelsong Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ad9c8b',
    background: '#352a21',
...
export const starlightPreset: TerminalTheme = {
  _id: 'preset-starlight',
  name: 'starlight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#242424',
...
export const SubliminalPreset: TerminalTheme = {
  _id: 'preset-subliminal',
  name: 'Subliminal', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#d4d4d4',
    background: '#282c35',
...
export const SugarplumPreset: TerminalTheme = {
  _id: 'preset-sugarplum',
  name: 'Sugarplum', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#db7ddd',
    background: '#111147',
...
export const synthwavePreset: TerminalTheme = {
  _id: 'preset-synthwave',
  name: 'synthwave', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dad9c7',
    background: '#000000',
...
export const synthwaveEverythingPreset: TerminalTheme = {
  _id: 'preset-synthwave-everything',
  name: 'synthwave-everything', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f0eff1',
    background: '#2a2139',
...
export const SynthwaveAlphaPreset: TerminalTheme = {
  _id: 'preset-synthwavealpha',
  name: 'SynthwaveAlpha', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f2f2e3',
    background: '#241b30',
...
export const TangoAdaptedPreset: TerminalTheme = {
  _id: 'preset-tango-adapted',
  name: 'Tango Adapted', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#ffffff',
...
export const TangoHalfAdaptedPreset: TerminalTheme = {
  _id: 'preset-tango-half-adapted',
  name: 'Tango Half Adapted', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#ffffff',
...
export const TerminalBasicPreset: TerminalTheme = {
  _id: 'preset-terminal-basic',
  name: 'Terminal Basic', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#ffffff',
...
export const TerminalBasicDarkPreset: TerminalTheme = {
  _id: 'preset-terminal-basic-dark',
  name: 'Terminal Basic Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#1d1e1d',
...
export const ThayerBrightPreset: TerminalTheme = {
  _id: 'preset-thayer-bright',
  name: 'Thayer Bright', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f8f8f8',
    background: '#1b1d1e',
...
export const TinaciousDesignDark_Preset: TerminalTheme = {
  _id: 'preset-tinacious-design-dark-',
  name: 'Tinacious Design (Dark)', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cbcbf0',
    background: '#1d1d26',
...
export const TinaciousDesignLight_Preset: TerminalTheme = {
  _id: 'preset-tinacious-design-light-',
  name: 'Tinacious Design (Light)', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#1d1d26',
    background: '#f8f8ff',
...
export const tokyonightPreset: TerminalTheme = {
  _id: 'preset-tokyonight',
  name: 'tokyonight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c0caf5',
    background: '#1a1b26',
...
export const tokyonightMoonPreset: TerminalTheme = {
  _id: 'preset-tokyonight-moon',
  name: 'tokyonight_moon', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c8d3f5',
    background: '#222436',
...
export const tokyonightNightPreset: TerminalTheme = {
  _id: 'preset-tokyonight-night',
  name: 'tokyonight_night', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c0caf5',
    background: '#1a1b26',
...
export const tokyonightDayPreset: TerminalTheme = {
  _id: 'preset-tokyonight-day',
  name: 'tokyonight-day', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#3760bf',
    background: '#e1e2e7',
...
export const tokyonightStormPreset: TerminalTheme = {
  _id: 'preset-tokyonight-storm',
  name: 'tokyonight-storm', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c0caf5',
    background: '#24283b',
...
export const TomorrowNightPreset: TerminalTheme = {
  _id: 'preset-tomorrow-night',
  name: 'Tomorrow Night', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c5c8c6',
    background: '#1d1f21',
...
export const TomorrowNightBluePreset: TerminalTheme = {
  _id: 'preset-tomorrow-night-blue',
  name: 'Tomorrow Night Blue', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#002451',
...
export const TomorrowNightBrightPreset: TerminalTheme = {
  _id: 'preset-tomorrow-night-bright',
  name: 'Tomorrow Night Bright', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#eaeaea',
    background: '#000000',
...
export const TomorrowNightBurnsPreset: TerminalTheme = {
  _id: 'preset-tomorrow-night-burns',
  name: 'Tomorrow Night Burns', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#a1b0b8',
    background: '#151515',
...
export const TomorrowNightEightiesPreset: TerminalTheme = {
  _id: 'preset-tomorrow-night-eighties',
  name: 'Tomorrow Night Eighties', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#cccccc',
    background: '#2d2d2d',
...
export const TreehousePreset: TerminalTheme = {
  _id: 'preset-treehouse',
  name: 'Treehouse', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#786b53',
    background: '#191919',
...
export const UltraDarkPreset: TerminalTheme = {
  _id: 'preset-ultradark',
  name: 'UltraDark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#000000',
...
export const UltraViolentPreset: TerminalTheme = {
  _id: 'preset-ultraviolent',
  name: 'UltraViolent', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c1c1c1',
    background: '#242728',
...
export const UnderTheSeaPreset: TerminalTheme = {
  _id: 'preset-underthesea',
  name: 'UnderTheSea', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#011116',
...
export const VibrantInkPreset: TerminalTheme = {
  _id: 'preset-vibrantink',
  name: 'VibrantInk', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#000000',
...
export const VioletDarkPreset: TerminalTheme = {
  _id: 'preset-violet-dark',
  name: 'Violet Dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#708284',
    background: '#1c1d1f',
...
export const VioletLightPreset: TerminalTheme = {
  _id: 'preset-violet-light',
  name: 'Violet Light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#536870',
    background: '#fcf4dc',
...
export const WildCherryPreset: TerminalTheme = {
  _id: 'preset-wildcherry',
  name: 'WildCherry', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dafaff',
    background: '#1f1726',
...
export const wilmersdorfPreset: TerminalTheme = {
  _id: 'preset-wilmersdorf',
  name: 'wilmersdorf', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#c6c6c6',
    background: '#282b33',
...
export const xcodedarkPreset: TerminalTheme = {
  _id: 'preset-xcodedark',
  name: 'xcodedark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#dfdfe0',
    background: '#292a30',
...
export const xcodedarkhcPreset: TerminalTheme = {
  _id: 'preset-xcodedarkhc',
  name: 'xcodedarkhc', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#ffffff',
    background: '#1f1f24',
...
export const xcodelightPreset: TerminalTheme = {
  _id: 'preset-xcodelight',
  name: 'xcodelight', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#262626',
    background: '#ffffff',
...
export const xcodelighthcPreset: TerminalTheme = {
  _id: 'preset-xcodelighthc',
  name: 'xcodelighthc', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#000000',
    background: '#ffffff',
...
export const xcodewwdcPreset: TerminalTheme = {
  _id: 'preset-xcodewwdc',
  name: 'xcodewwdc', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#e7e8eb',
    background: '#292c36',
...
export const zenbonesDarkPreset: TerminalTheme = {
  _id: 'preset-zenbones-dark',
  name: 'zenbones_dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#b4bdc3',
    background: '#1c1917',
...
export const zenbonesLightPreset: TerminalTheme = {
  _id: 'preset-zenbones-light',
  name: 'zenbones_light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#2c363c',
    background: '#f0edec',
...
export const zenburnedPreset: TerminalTheme = {
  _id: 'preset-zenburned',
  name: 'zenburned', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#f0e4cf',
    background: '#404040',
...
export const zenwrittenDarkPreset: TerminalTheme = {
  _id: 'preset-zenwritten-dark',
  name: 'zenwritten_dark', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#bbbbbb',
    background: '#191919',
...
export const zenwrittenLightPreset: TerminalTheme = {
  _id: 'preset-zenwritten-light',
  name: 'zenwritten_light', // 移除扩展名并转义单引号
  isPreset: true,
  themeData: {
    foreground: '#353535',
    background: '#eeeeee',
...
export const presetTerminalThemes: TerminalTheme[] = [
  ...
  AndromedaPreset,
  AppleClassicPreset,
  AppleSystemColorsPreset,
  AppleSystemColorsLightPreset,
  arcoirisPreset,
  ArdoisePreset,
  ArgonautPreset,
  ArthurPreset,
  AtelierSulphurpoolPreset,
  AtomPreset,
  AtomOneDarkPreset,
  AtomOneLightPreset,
  AuraPreset,
  ...
  AyuMiragePreset,
  ayuLightPreset,
  BananaBlueberryPreset,
  BatmanPreset,
  BelafonteDayPreset,
  BelafonteNightPreset,
  BirdsOfParadisePreset,
  BlazerPreset,
  BlueMatrixPreset,
  BlueBerryPiePreset,
  BlueDolphinPreset,
  ...
  BuiltinDarkPreset,
  BuiltinLightPreset,
  BuiltinPastelDarkPreset,
  BuiltinSolarizedDarkPreset,
  BuiltinSolarizedLightPreset,
  BuiltinTangoDarkPreset,
  BuiltinTangoLightPreset,
  C64Preset,
  CalamityPreset,
  ...
  Cobalt2Preset,
  CobaltNextPreset,
  CobaltNextDarkPreset,
  CobaltNextMinimalPreset,
  coffeeThemePreset,
  CrayonPonyFishPreset,
  CutieProPreset,
  CyberdynePreset,
  cyberpunkPreset,
  CyberpunkScarletProtocolPreset,
  DarkModernPreset,
  DarkPastelPreset,
  Dark_Preset,
  darkermatrixPreset,
  ...
  EspressoLibrePreset,
  EverblushPreset,
  EverforestDarkHardPreset,
  FahrenheitPreset,
  FairyflossPreset,
  farmhouseDarkPreset,
  farmhouseLightPreset,
  FideloperPreset,
  FireflyTraditionalPreset,
  FirefoxDevPreset,
  FirewatchPreset,
  FishTankPreset,
  FlatPreset,
  ...
  ForestBluePreset,
  FramerPreset,
  FrontEndDelightPreset,
  FunForrestPreset,
  GalaxyPreset,
  GalizurPreset,
  GhosttyDefaultStyleDarkPreset,
  GithubPreset,
  GitHubDarkPreset,
  GitHubDarkColorblindPreset,
  GitHubDarkDefaultPreset,
  GitHubDarkDimmedPreset,
  GitHubDarkHighContrastPreset,
  GitHubLightColorblindPreset,
  GitHubLightDefaultPreset,
  GitHubLightHighContrastPreset,
  GitLabDarkPreset,
  GitLabDarkGreyPreset,
  GitLabLightPreset,
  GlacierPreset,
  GrapePreset,
  GrassPreset,
  GreyGreenPreset,
  gruberDarkerPreset,
  gruvboxMaterialPreset,
  GruvboxDarkPreset,
  GruvboxDarkHardPreset,
  GruvboxLightPreset,
  GruvboxLightHardPreset,
  GuezwhozPreset,
  HacktoberPreset,
  HardcorePreset,
  HarperPreset,
  ...
  IRIXConsolePreset,
  IRIXTerminalPreset,
  iTerm2DarkBackgroundPreset,
  iTerm2DefaultPreset,
  iTerm2LightBackgroundPreset,
  iTerm2PastelDarkBackgroundPreset,
  iTerm2SmooooothPreset,
  iTerm2SolarizedDarkPreset,
  iTerm2SolarizedLightPreset,
  iTerm2TangoDarkPreset,
  iTerm2TangoLightPreset,
  JackieBrownPreset,
  JapanesquePreset,
  JellybeansPreset,
  JetBrainsDarculaPreset,
  jubiPreset,
  KanagawaDragonPreset,
  KanagawaWavePreset,
  kanagawabonesPreset,
  KibblePreset,
  KoloritPreset,
  ...
  LabFoxPreset,
  LaserPreset,
  LaterThisEveningPreset,
  LavandulaPreset,
  LightOwlPreset,
  LiquidCarbonPreset,
  LiquidCarbonTransparentPreset,
  LiquidCarbonTransparentInversePreset,
  lovelacePreset,
  ManPagePreset,
  MarianaPreset,
  MaterialPreset,
  MaterialDarkPreset,
  MaterialDarkerPreset,
  MaterialDesignColorsPreset,
  MaterialOceanPreset,
  MathiasPreset,
  matrixPreset,
  MedallionPreset,
  ...
  mellowPreset,
  miasmaPreset,
  midnightInMojavePreset,
  MiragePreset,
  MisteriosoPreset,
  MolokaiPreset,
  MonaLisaPreset,
  MonokaiClassicPreset,
  MonokaiProPreset,
  MonokaiProLightPreset,
  MonokaiProLightSunPreset,
  MonokaiProMachinePreset,
  MonokaiProOctagonPreset,
  MonokaiProRistrettoPreset,
  MonokaiProSpectrumPreset,
  MonokaiRemasteredPreset,
  MonokaiSodaPreset,
  MonokaiVividPreset,
  moonflyPreset,
  N0tch2kPreset,
  ...
  NeopolitanPreset,
  NeutronPreset,
  NightOwlishLightPreset,
  nightfoxPreset,
  NightLionV1Preset,
  NightLionV2Preset,
  NightOwlPreset,
  nijiPreset,
  NocturnalWinterPreset,
  nordPreset,
  nordLightPreset,
  nordWavePreset,
  NovelPreset,
  ...
  OceanPreset,
  OceanicNextPreset,
  OceanicMaterialPreset,
  OlliePreset,
  OneDoubleDarkPreset,
  OneDoubleLightPreset,
  OneHalfDarkPreset,
  OneHalfLightPreset,
  OperatorMonoDarkPreset,
  OvernightSlumberPreset,
  OxocarbonPreset,
  PaleNightHCPreset,
  PandoraPreset,
  ParaisoDarkPreset,
  ...
  RyuukoPreset,
  SakuraPreset,
  ScarletProtocolPreset,
  SeafoamPastelPreset,
  SeaShellsPreset,
  seoulbonesDarkPreset,
  seoulbonesLightPreset,
  SetiPreset,
  shadesOfPurplePreset,
  ShamanPreset,
  SlatePreset,
  SleepyHollowPreset,
  SmyckPreset,
  ...
  SnazzySoftPreset,
  SoftServerPreset,
  SolarizedDarculaPreset,
  SolarizedDarkPatchedPreset,
  SolarizedDarkHigherContrastPreset,
  solarizedOsakaNightPreset,
  sonokaiPreset,
  SpacedustPreset,
  SpaceGrayPreset,
  SpaceGrayBrightPreset,
  SpaceGrayEightiesPreset,
  SpaceGrayEightiesDullPreset,
  SpidermanPreset,
  SpringPreset,
  SquarePreset,
  SquirrelsongDarkPreset,
  srceryPreset,
  starlightPreset,
  SublettePreset,
  SubliminalPreset,
  ...
  SymfonicPreset,
  synthwavePreset,
  synthwaveEverythingPreset,
  SynthwaveAlphaPreset,
  TangoAdaptedPreset,
  TangoHalfAdaptedPreset,
  TeerbPreset,
  terafoxPreset,
  TerminalBasicPreset,
  TerminalBasicDarkPreset,
  ThayerBrightPreset,
  TheHulkPreset,
  TinaciousDesignDark_Preset,
  TinaciousDesignLight_Preset,
  tokyonightPreset,
  tokyonightMoonPreset,
  tokyonightNightPreset,
  tokyonightDayPreset,
  tokyonightStormPreset,
  TomorrowPreset,
  TomorrowNightPreset,
  TomorrowNightBluePreset,
  TomorrowNightBrightPreset,
  TomorrowNightBurnsPreset,
  TomorrowNightEightiesPreset,
  ToyChestPreset,
  TreehousePreset,
  TwilightPreset,
  UbuntuPreset,
  ...
  ZenburnPreset,
  zenburnedPreset,
  zenwrittenDarkPreset,
  zenwrittenLightPreset,
];
